...
function updateOrganizationInDBActivity(organization, id) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c;
        try {
            let orgId = new mongoose_1.default.Types.ObjectId(id);
            let newOrganization = yield OrganizationModel_1.OrganizationModel.findByIdAndUpdate(orgId, organization);
